...
<div class="container-fluid mt-5">
  <div class="jumbotron">
    <h1>Alicyart Studio's</h1>
    <p>
      <strong>Alicyart Studio's</strong><i>"merupakan website yang menyediakan jasa design produk yang menarik<br>dengan harga yang terjangkau.
    Sosmed, Branding, Ilustration, Printed Needs."</i>
    </p>
  </div>
</div>
<!-- Jumbotron -->
...
<div class="barier mt-5 mb-3">
    <center>
        <p><strong><i>Ini Contoh Testimoni Nya Ya!</i></strong></p>
    </center>
</div>
<!-- Barier -->
