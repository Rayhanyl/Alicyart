    ...
    <div class="col-sm-6 text-center">
      <div class="container">
        <div class="profile">
          ...
          <hr>
          <p class="pb-3">
            <a href="edit_profile.php?id_user=<?= $_SESSION['id_user']?>" type="button" class="btn btn-primary"
              style="border-radius:20px;"><?= $_SESSION['role'] ?></a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6 mt-3">
      <div class="container-fluid">
        ...
        while($row = mysqli_fetch_array($data))
        {
                  ...
                  <div class="row">
                    <div class="col-xm pl-3 pr-1">
                      <button type="button" class="btn btn-success" data-toggle="modal"
                        data-target="#myModal<?= $row['id_order'];?>">Detail order</button>
                    </div>
                    <div class="col-xm pl-1">
                      ...
                      <?php } else { ?>
                      <?php if ( $row['status'] == '1'){ ?>
                      <button class="btn-invoice btn btn-primary" type="button" name="order" data-toggle="modal"
                        data-target="#myUpload" data-order="<?=$row['id_order'];?>" data-product="<?=$row['product'];?>"
          ...
          <!-- Modal -->
          <!-- Optional JavaScript -->
          <div class="modal fade" id="myModal<?= $row['id_order']; ?>" tabindex="-1" role="dialog"
                          ...
                          <table border="0" width="100%" style="padding-left: 2px; padding-right: 13px;">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>:</td>
                                <td><textarea class="form-control mt-3 mb-3" rows="3"
                                    disabled><?= $row['o_deskripsi'];?></textarea></td>
                              </tr>
                              <tr>
                                <td>Faktur</td>
                                <td>:</td>
                                <td>
                                  <img src="assets/img/faktur/<?php echo htmlentities($row['faktur']);?>"
                                    class="responsive">
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td>:</td>
                                <td>
                                  <img src="assets/img/invoice/<?php echo htmlentities($row['invoice']);?>"
                                    class="responsive">
                                </td>
                              </tr>
                              <tr class="mt-3">
